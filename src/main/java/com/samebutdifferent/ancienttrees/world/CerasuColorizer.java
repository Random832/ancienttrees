...
public enum CerasuColorizer implements IResourceManagerReloadListener, IBlockColor {
    INSTANCE;
    ...
    public void onResourceManagerReload(IResourceManager resourceManager) {
        try {
            buffer = TextureUtil.readResource(resourceManager.getResource(new ResourceLocation(AncientTrees.MOD_ID, "textures/colormap/cerasu.png")).getInputStream());
